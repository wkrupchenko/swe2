...
public class SucheBezeichnungActivity extends Activity {
	...
	private void suchen(String bezeichnung) {
		final ArrayList<? extends Artikel> artikel = artikelServiceBinder.sucheArtikelNachBezeichnung(bezeichnung, this).resultList;
		Log.d(LOG_TAG, bezeichnung.toString());
